...
| ![two_gates_aqua](results/two_gates_aqua.jpg) | [@Stifeev][Stifeev] | [CognitivePortrait-ThirdEye.ipynb](CognitivePortrait-ReflectionAqua.py) | Выравнивание с использование меток, отражения, акварельный фильтр |
|----|----|----|----|
